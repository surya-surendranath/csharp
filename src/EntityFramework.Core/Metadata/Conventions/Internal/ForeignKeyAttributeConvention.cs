...
namespace Microsoft.Data.Entity.Metadata.Conventions.Internal
{
    public class ForeignKeyAttributeConvention : IForeignKeyConvention
    {
        public virtual InternalRelationshipBuilder Apply(InternalRelationshipBuilder relationshipBuilder)
        {
            ...
            var fkPropertyOnEntityType = fkPropertyOnDependent ?? fkPropertyOnPrincipal;
            ...
            {
                if (fkPropertyOnEntityType == null)
                {
                    return relationshipBuilder;
                }
            ...
            else
            {
                ...
                else
                {
                    if (fkPropertiesOnNavigation.Count != 1
                        || !string.Equals(fkPropertiesOnNavigation.First(), fkPropertyOnEntityType))
                    {

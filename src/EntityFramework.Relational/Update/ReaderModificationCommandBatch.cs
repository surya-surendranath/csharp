...
namespace Microsoft.Data.Entity.Update
{
    public abstract class ReaderModificationCommandBatch : ModificationCommandBatch
    {
        ...
        protected virtual DbCommand CreateStoreCommand(
            ...
            int? commandTimeout)
        {
            var commandBuilder = new RelationalCommandBuilder(typeMapper);
            ...
            var command = commandBuilder.RelationalCommand.CreateDbCommand(connection);
        ...
        protected virtual void PopulateParameters(RelationalParameterList parameterList, ColumnModification columnModification)
        {
            ...
            {
                var parameterName = columnModification.ParameterName.Substring(1);
            ...
            {
                var parameterName = columnModification.OriginalParameterName.Substring(1);
